"""Test a saved GNN-PPO-ALNS checkpoint on precomputed instances."""
...
from gnn_ppo_alns.gnn import GraphBuilder
from gnn_ppo_alns.ppo import (REWARD_MODES, evaluate_instance, load_model,
...
def main():
    ...
    for instance_id, params in cases:
        for seed in range(args.seeds):
            solution, stats = evaluate_instance(model, cfg, builder, params,
                                                seed=seed,
