...
from v2_claude.common.artifacts import (reserve_artifacts, validate_data_tag, validate_run_label,
                              write_csv, write_json)
from v2_claude.common.runtime import report_training_runtime
from v2_claude.gnn_ppo_alns.alns import DirectoryInstanceProvider
from v2_claude.gnn_ppo_alns.gnn import compute_norms
from v2_claude.gnn_ppo_alns.ppo import (PPOConfig, REWARD_MODES,
...
def main():
    ...
    with reserve_artifacts([model_path, csv_path, updates_path, metadata_path]):
        ...
        metadata = {
            "schema_version": 2,
            "status": "completed",
            "model": "gnn_ppo_alns", "variant": "v2_claude",
            "size": args.size,
            "tag": args.tag,
            "reward_mode": args.reward_mode,
