...
from v2_codex.common.artifacts import (reserve_artifacts, validate_data_tag, validate_run_label, write_csv,
                              write_json)
from common.params import DEFAULT_PARAMS_PATH, REPO_ROOT
from v2_codex.common.runtime import report_training_runtime
from v2_codex.ppo_alns.alns import DirectoryInstanceProvider
from v2_codex.ppo_alns.ppo import (PPOConfig, REWARD_MODES, reward_artifact_token,
                          train)
...
def main():
    ...
    with reserve_artifacts([model_path, log_path, updates_path, metadata_path]):
        ...
        metadata = {
            "schema_version": 2, "status": "completed", "model": "ppo_alns",
